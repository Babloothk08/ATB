        ...
        <section className="py-20 bg-white">
            ...
            >
                ...
                <p className="text-gray-600 mb-14 leading-relaxed max-w-3xl mx-auto text-lg">
                    Discover cheap flights from the USA to Europe and Canada with top airlines.
                    Enjoy smooth booking, flexible fares, and travel without breaking your budget.
                </p>
            </motion.div>
            ...
            >
                ...
                <p className="text-gray-600 max-w-2xl mx-auto">
                    Discover the most affordable flights to incredible destinations around the world.
